...
public class Result
{
    ...
    public static Result Failure(string errorMessage, ErrorType errorType = Shared.ErrorType.Unknown)
        => new Result(errorMessage, errorType);
    
    public static Result InternalServerError() =>
        new("An internal error occured. Please, try later.", Shared.ErrorType.ServerError);
}
...
public class Result<T> : Result
{
    ...
    public new static Result<T> Failure(string errorMessage, ErrorType errorType = Shared.ErrorType.Unknown)
